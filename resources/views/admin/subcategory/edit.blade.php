...
@section('content')
        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('subCat.index') }}" class="btn btn-primary">Back</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
    ...
    <section class="content">
        <!-- Default box -->
        <form action="{{ route('subCat.update',$subcategory->id) }}" method="post" name="subCategoryForm" id="subCategoryForm">
            <div class="container-fluid">
                ...
                <div class="pb-5 pt-3">
                    ...
                    <a href="{{ route('subCat.index')}}" class="btn btn-outline-dark ml-3">Cancel</a>
                </div>
            </div>
        </form>
        <!-- /.card -->
...
@section('customScript')
    ...
    $.ajax({
        ...
        success:function(response) {
            ...
            if(response['status'] == true) {
                const redirectToList = '{{ route("subCat.index") }}';
