...
<section class="content-header">					
            ...
            <form action="" method="get">
							...
							<div class="card-title">
									<button type="button" onclick="window.location.href='{{route('page.index')}}'"class="btn btn-default btn-sm">Reset</button>
							</div>
...
function deletePage(pageId) {
    if (confirm('Are you sure you want to delete this page?')) {
        // Construct the delete URL using the pageId
        const deleteRoute = "{{ route('page.destroy','ID') }}";
        const newdeleteRoute = deleteRoute.replace("ID",pageId);
		$.ajax({
			url:newdeleteRoute,
			type:'delete',
			data:{},
