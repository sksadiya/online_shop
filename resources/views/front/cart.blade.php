                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group quantity mx-auto" style="width: 100px;">
                                            ...
                                            <input type="text" name="quantity" class="form-control form-control-sm  border-0 text-center" value="{{$item->qty}}">
                                            <div class="input-group-btn">
                                    ...
                                    <td>
                                    <button class="btn btn-sm btn-danger" onclick="removeCart('{{ $item->rowId }}')"><i class="fa fa-times"></i></button>
                                    </td>
                                </tr> 
                                @endforeach  
                            </tbody>
